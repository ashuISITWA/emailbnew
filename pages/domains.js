...
import LeftSidebarDomain from "../components/domain/LeftSidebarDomain";
  ...
  return (
    <>
      <div className="flex items-stretch">
        ...
        <LeftSidebarDomain />
        <div className="flex flex-1 flex-col md:pl-[270px] md:pr-8">
              ...
              <div className="sm:flex sm:items-center">
                ...
                <div className="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                  <div className="flex gap-2">
                    <Link
                      href="/mailaccounts"
                      className="inline-flex items-center text-sm font-medium bg-slate-900 rounded-md transition-colors text-white h-9 px-4 py-2.5  bg-brand-500 hover:bg-slate-700  "
                    >
                      ...
                      <table className="min-w-full divide-y divide-gray-300">
                        <thead className="bg-gray-50">
                          <tr>
                            <th
                              scope="col"
                              className="py-2 pl-4 pr-3 text-left text-[12px] font-semibold text-gray-600 sm:pl-6 lg:pl-8 uppercase"
                            >
                              No.
                            </th>
                            <th
                            ...
                            <th
                              scope="col"
                              className="relative py-3.5 pl-3 pr-4 sm:pr-6 lg:pr-8 uppercase"
                            >
